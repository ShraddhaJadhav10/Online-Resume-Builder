        ...
        <%
            ...
            try {
                ...
                rs = st.executeQuery("select CAND_ID,CAND_FULLNM,CAND_DOB,CAND_GENDER,COUNTRY_NM,STATE_NM,"
                        + "CITY_NM,CAND_ADDR,CAND_MOBILE,CAND_PHNO,CAND_EMAIL,CAND_PHOTO from CANDIDATE_MASTER,COUNTRY,STATE,CITY WHERE CANDIDATE_MASTER.COUNTRY_ID=COUNTRY.COUNTRY_ID AND CANDIDATE_MASTER.STATE_ID=STATE.STATE_ID AND CANDIDATE_MASTER.CITY_ID=CITY.CITY_ID AND CANDIDATE_MASTER.CAND_ID=" + candid);
                ...
                while (rs.next()) {
                    ...
                    CAND_PHOTO = "Upload/" + rs.getString(12);
            ...
            <div class="container">
                <div class="cover shadow-lg bg-white">
                    <div class="cover-bg p-3 p-lg-4 text-white">
                        <div class="row">
                            <div class="col-lg-4 col-md-5">
                                <div class="avatar hover-effect bg-white shadow-sm p-1"><img src="<%=CAND_PHOTO%>" width="200" height="200"/></div>
                            </div>
                            <div class="col-lg-8 col-md-7 text-center text-md-start">
                                ...
                                <div class="d-print-none" data-aos="fade-left" data-aos-delay="200"><a class="btn btn-light text-dark shadow-sm mt-1 me-1" onclick="window.print()" href="right-resume.pdf" target="_blank">Download CV</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="about-section pt-4 px-3 px-lg-4 mt-1">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p>Hello! I?m <%= CAND_FULLNM%>. I am passionate about UI/UX design and Web Design. I am a skilled Front-end Developer and master of Graphic Design tools such as Photoshop and Sketch.</p>
                            </div>
                            <div class="col-md-5 offset-md-1">
                                <div class="row mt-2">
                                    <div class="col-sm-4">
                                        <div class="pb-1">dob</div>
                                    </div>
                                    <div class="col-sm-8">
                    ...
                    <div class="skills-section px-3 px-lg-4">
                        <h2 class="h2 mb-3">Professional Skills</h2>
                        <div class="row">
                            <div class="col-md-6">
                                <%   rs = st.executeQuery("select * from CANDIDATE_SKILLS   where CAND_ID=" + candid);
                                    while (rs.next()) {
                    ...
                    <div class="work-experience-section px-3 px-lg-4">
                        ...
                        <div class="project_details">                         
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                    <h4 class="title2" style="font-family: ">Extra Circular Activities</h4>
                        ...
                        <hr class="d-print-none"/>
                        <div class="work-experience-section px-3 px-lg-4">
                            <h2 class="h2 mb-4">Academic Details</h2>
                            ...
                            <div class="project_details">                         
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <h4 class="title2" style="font-family: ">PG</h4>
                                        <p class="title2"><%=PG%></p>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">

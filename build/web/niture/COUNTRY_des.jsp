<%-- 
    Document   : COUNTRY_des
    Created on : 17 Oct, 2022, 2:49:26 PM
    Author     : softtech
--%>
   ...
   <div class="container-fluid">
        ...
        public int GetNewID()
        {
            ...
            try
            {
                ...
                rs=st.executeQuery("select max(COUNTRY_ID)from COUNTRY");
                if(rs.next())
                {
                    maxid=rs.getInt(1);
                }
          ...
          if(request.getQueryString()!=null)
            {
                ...
                COUNTRY_NM=request.getParameter("COUNTRY_NM");

                
            }
          else
          {
              COUNTRY_ID=String.valueOf(GetNewID());
          }
         ...
         <div class="container-fluid padddd">
            ...
            <div class="row main_form">
               ...
               <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                <form action="COUNTRY_master.jsp">
                   <div class="row">
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                           ID <input class="form-control" type="text" value="<%=COUNTRY_ID%>" name="COUNTRY_ID.text"/><br>
                       </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    Name <input class="form-control" type="text" value="<%=COUNTRY_NM%>" name="COUNTRY_NM.text"/><br>
                        </div>             
             <%
               if(flag==0)
               {
        ...
        <%
             ...
             out.println("<table class='table'><tr><th>ID</th><th>Name</th><th>Select</th></tr>");
             while(rs.next())
             {
                out.println("<tr>");
                out.println("<td>"+rs.getInt(1)+"</td>");
                out.println("<td>"+rs.getString(2)+"</td>");
                out.println("<td><a href='COUNTRY_des.jsp?COUNTRY_ID="+rs.getInt(1)+"&COUNTRY_NM="+rs.getString(2)+"'>Select</a></td>");
               out.println("</tr>");
             }
             out.println("</table>");
             cn.close();

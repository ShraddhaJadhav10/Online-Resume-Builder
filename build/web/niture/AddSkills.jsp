   ...
   <div class="container-fluid">
      ...
      <%!
        ...
        <%
             ...
             rs=st.executeQuery("select * from candidate_skills where CAND_ID="+session.getAttribute("id"));
                         
             while(rs.next())
             {
             
                SKILL_ID=rs.getString(1);
                CAND_ID=rs.getString(2);
                SKILLSKNOW=rs.getString(3);
                SKILLSDETAILS=rs.getString(4);
                SKILL_AVG_PERCENTAGE=rs.getString(4);
         ...
         <div class="container-fluid padddd">
              ...
              <div class="row main_form">
               ...
               <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                   <form action="AddSkills_code.jsp">
